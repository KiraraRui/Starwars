...
namespace Starwars
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //// The assignment said 6 but in the room it was said to be 9 instead.
            ...
            //var col4 = planets.Where(x => x.Name[1] == 'a' && x.Name.EndsWith("e"));
            ...
            //col7 = col7.OrderBy(x => x.RotationPeriod);
            //col7 = col7.OrderBy(x => x.Name);
            ...
            //var col8 = planets.Where(x => (x.RotationPeriod < 30 || x.SurfaceWater > 50 ) && x.Name.Contains("ba"));
            ...
            //var col10 = planets.Where(x => x.Diameter > 0 && x.Population > 0).OrderBy(p => (4 * Math.PI * Math.Pow(p.Diameter / 2,2)) / p.Population);
            ...
            //List<Planet> rotationList = new List<Planet>();
            //rotationList = planets.Where(x => x.RotationPeriod > 0).ToList();
            //var col11 = planets.Except(rotationList, new NameComparer());
            ...
            //List<Planet> rotationList = new List<Planet>();
            //List<Planet> terrainList = new List<Planet>();

            //rotationList = planets.Where(x => x.Name.ToLower().StartsWith("a") || x.Name.EndsWith("s")).ToList();
            //terrainList = planets.Where(x => x.Terrain != null && x.Terrain.Contains("rainforests")).ToList();

            //var col12 = rotationList.Union(terrainList);
            ...
            //var col3 = planets.Where(x => x.Terrain != null &&( x.Terrain.Contains("desert") || x.Terrain.Contains("deserts") || x.Terrain.Contains("rocky deserts")));
            ...
            //var col4 = planets.Where(x => x.Terrain != null && (x.Terrain.Contains("swamp") || x.Terrain.Contains("swamps"))).OrderBy(x => x.RotationPeriod).ThenBy(x => x.Name);
            ...
            //var col5 = planets.Where(x => Regex.IsMatch(x.Name, @"(a{2}|e{2}|i{2}|o{2}|u{2})"));
            ...
            //var col6 = planets.Where(x => Regex.IsMatch(x.Name, @"(k{2}|l{2}|r{2}|n{2})")).OrderByDescending(x => x.Name);
